...
hl.animation({leaf = "layersIn", enabled = true, speed = 5, bezier = "default", style = "popin"})
hl.animation({leaf = "layersOut", enabled = true, speed = 5, bezier = "default", style = "popin"})
hl.animation({leaf = "fadeLayersIn", enabled = true, speed = 10, bezier = "default"})
hl.animation({leaf = "fadeLayersOut", enabled = true, speed = 10, bezier = "default"})
hl.animation({leaf = "workspacesIn", enabled = true, speed = 7, bezier = "overshot", style = "slidevert"})
hl.animation({leaf = "workspacesOut", enabled = true, speed = 7, bezier = "overshot", style = "slidevert"})
...
hl.animation({leaf = "specialWorkspaceIn", enabled = true, speed = 7, bezier = "overshot", style = "slidevert"})
hl.animation({leaf = "specialWorkspaceOut", enabled = true, speed = 7, bezier = "overshot", style = "slidevert"})
